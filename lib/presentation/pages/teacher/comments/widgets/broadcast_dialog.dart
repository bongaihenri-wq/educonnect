// lib/presentation/pages/teacher/comments/widgets/broadcast_dialog.dart
...
class _BroadcastDialogState extends State<BroadcastDialog> {
  ...
  Future<void> _send() async {
    if (_commentController.text.trim().isEmpty) {
      _showSnack('Veuillez saisir un message', Colors.orange);
      return;
    }
    if (_recipients.isEmpty) {
      _showSnack('Sélectionnez au moins un destinataire', Colors.orange);
      return;
    }
    ...
    try {
      ...
      await repo.saveBroadcastComment(
      ...
      if (mounted) {
        ...
        _showSnack('✅ Message envoyé à toute la classe !', const Color(0xFF14B8A6));
      }
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      title: Row(
        children: [
          const Icon(Icons.campaign, color: Color(0xFF7C3AED)),
          const SizedBox(width: 10),
          Expanded(child: Text('📢 ${widget.className}')),
        ],
      ),
          ...
          children: [
            TextField(
              ...
              decoration: const InputDecoration(
                hintText: 'Ex: Devoir de Maths page 42, exercices 3 à 5. À rendre jeudi.',
      ...
      actions: [
        ...
        ElevatedButton(
          ...
          onPressed: _send,
          child: const Text('Envoyer à la classe'),
        ),
      ],
