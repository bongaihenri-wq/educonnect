// lib/presentation/pages/teacher/comments/widgets/individual_comment_dialog.dart
...
class IndividualCommentDialog extends StatefulWidget {
  final StudentModel student;
  final String classId;
  final String className;

  const IndividualCommentDialog({
    super.key,
  ...
  @override
  State<IndividualCommentDialog> createState() => _IndividualCommentDialogState();
}

class _IndividualCommentDialogState extends State<IndividualCommentDialog> {
  ...
  Future<void> _send() async {
    ...
    try {
      ...
      if (mounted) {
        ...
        _showSnack('✅ Commentaire envoyé !', const Color(0xFF14B8A6));
      }
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      title: Text('💬 Commentaire - ${widget.student.fullName}'),
